...
@class ACUserConnection;
@protocol ACUserConnectionDelegate <NSObject>

@required

- (void) acUserConnection:(ACUserConnection *_Nonnull)connection didStateChanged:(ACUConnectionState)state;
- (void) acUserConnection:(ACUserConnection *_Nonnull)connection didRespone:(REQUEST)req resultCode:(int)result msg:(NSString *_Nullable)msg obj:(NSObject *_Nullable)obj;
- (void) acUserConnection:(ACUserConnection *_Nonnull)connection didTokenChanged:(NSString*_Nonnull)token;
@end


@interface ACUserConnection : NSObject
@property (nonatomic, assign) id<ACUserConnectionDelegate> _Nullable delegate;
